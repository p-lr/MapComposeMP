...
package ovh.plrapps.mapcompose.vector.spec
...
data class Tile(
    ...
    companion object : pbandk.Message.Companion<Tile> {
        val defaultInstance: Tile by lazy { Tile() }
    ...
    sealed class GeomType(override val value: Int, override val name: String? = null) : pbandk.Message.Enum {
        ...
        object UNKNOWN : GeomType(0, "UNKNOWN")
        object POINT : GeomType(1, "POINT")
        object LINESTRING : GeomType(2, "LINESTRING")
        object POLYGON : GeomType(3, "POLYGON")
        class UNRECOGNIZED(value: Int) : GeomType(value)

        companion object : pbandk.Message.Enum.Companion<GeomType> {
            val values: List<GeomType> by lazy { listOf(UNKNOWN, POINT, LINESTRING, POLYGON) }
    ...
    data class Value(
        ...
        companion object : pbandk.Message.Companion<Value> {
            val defaultInstance: Value by lazy { Value() }
    ...
    data class Feature(
        ...
        override val protoSize: Int by lazy { super.protoSize }
        companion object : pbandk.Message.Companion<Feature> {
            val defaultInstance: Feature by lazy { Feature() }
    ...
    data class Layer(
        ...
        override val protoSize: Int by lazy { super.protoSize }
        companion object : pbandk.Message.Companion<Layer> {
...
fun Tile?.orDefault(): Tile = this ?: Tile.defaultInstance
...
fun Tile.Value?.orDefault(): Tile.Value = this ?: Tile.Value.defaultInstance
...
fun Tile.Feature?.orDefault(): Tile.Feature = this ?: Tile.Feature.defaultInstance
