...
import ovh.plrapps.mapcompose.vector.spec.style.Filter.Companion.TYPE_PROPERTY
import kotlin.test.*
...
class FilterTest {
    ...
    fun testParseComplexFilterJson() {
        ...
        assertEquals("type", (typeFilter.left).property)
        assertTrue(typeFilter.right is FilterOperand.Literal)
        assertEquals("Point", (typeFilter.right).value)
    ...
    fun testParseNestedFilterJson() {
        ...
        assertEquals("class", (notInFilter.key).property)
    ...
    fun testParseTypeAndClassFilter() {
        ...
        assertTrue(typeFilter is Filter.Eq)
        assertTrue(typeFilter.left is FilterOperand.Get)
        assertEquals(TYPE_PROPERTY, (typeFilter.left).property)
        assertTrue(typeFilter.right is FilterOperand.Literal)
        assertEquals("Polygon", (typeFilter.right).value)
    ...
    fun testParseRiverBrunnelFilter() {
        ...
        assertEquals("brunnel", (eqFilter.left).property)
        assertTrue(eqFilter.right is FilterOperand.Literal)
        assertEquals("tunnel", (eqFilter.right).value)
    }
} 